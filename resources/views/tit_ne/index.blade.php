...
@section('htmlheader_title')
	Titulares Niños y Embarazadas "MONTO CERO"
@endsection
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="panel panel-default">
					...
					<div class="panel-heading"> Titulares Niños y Embarazadas "MONTO CERO" </div>
					<div class="panel-body">
						@include('bones-flash::bones.flash')
						@include('layouts.partials.flash')

           {!! Form::open(['action' => 'MTitularesNE@store']) !!}
            ...
            <div class="col-md-11 col-md-offset-1">
                ...
                <hr>
                    ...
                    <br>
                    <h3>
                        <span class="label label-primary">{{ trans('Seleccione el Monto') }}</span>
                    </h3>
                    <hr>
                        <div class="input-group has-info form-inline col-xs-5">
                                <span class="input-group-addon" id="primernombre">MONTO</span>
                                        <select class="form-control" name="monto" id="monto" data-placeholder="Seleccione el Monto..."  required>
                                                <option value="0">$ 0.0 - MONTO CERO</option>
