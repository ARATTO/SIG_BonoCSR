...
@section('htmlheader_title')
	Niños Que Faltaron a sus controlles
@endsection
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="panel panel-default">
					...
					<div class="panel-heading"> Seleccion de datos para ver niños que no fueron llevados a sus controles </div>
					<div class="panel-body">
						@include('bones-flash::bones.flash')
						@include('layouts.partials.flash')

           {!! Form::open(['action' => 'ChildControlesController@store']) !!}
